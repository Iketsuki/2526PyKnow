...
## Common Errors
- Accessing variable outside scope: not defined.
- Modifying global without `global` keyword: UnboundLocalError.
- Thinking local variable changes global (it doesn't).
